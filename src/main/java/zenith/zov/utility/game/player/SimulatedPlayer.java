...
public class SimulatedPlayer implements IClient {
    ...
    public static SimulatedPlayer fromOtherPlayer(PlayerEntity player, SimulatedPlayerInput input) {
        return new SimulatedPlayer(
                ...
                input,
                player.getPos(),
                player.getPos().subtract(new Vec3d(player.lastX, player.lastY, player.lastZ)),
                player.getBoundingBox(),
                player.getYaw(),
                player.getPitch(),
                player.isSprinting(),
    ...
    public static class SimulatedPlayerInput extends Input {
        ...
        public static SimulatedPlayerInput guessInput(PlayerEntity entity) {
            Vec3d velocity = entity.getPos().subtract(new Vec3d(entity.lastX, entity.lastY, entity.lastZ));
